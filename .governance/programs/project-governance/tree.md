...
- [x] P0.8g: OpenStock shadow persistence opt-in design [decision] (closed, FT: sources/)
- [x] P0.8h: OpenStock analysis wider fixture loop (indicators + strategy) [decision] (closed, FT: sources/)
- [x] P0.8g-impl: OpenStock shadow persistence write path (production-code) [decision] (closed, FT: sources/)
...
| P0.8g | Design gate closed after P0.8g-impl implementation landed. | `8ad62a12e5a0c1842eb45d4bf690d370428273bf` | Design gate closed after P0.8g-impl implementation landed. |
| P0.8h | Node closed. §5h.1-5h.7 all complete; §5h.7 explicitly defers BacktestEngine feed to a separate production-code slice. Slice delivered end-to-end local fixture loop for indicators + strategy without production code changes. | `8ad62a12e5a0c1842eb45d4bf690d370428273bf` | Node closed. §5h.1-5h.7 all complete; §5h.7 explicitly defers BacktestEngine feed to a separate production-code slice. Slice delivered end-to-end local fixture loop for indicators + strategy without production code changes. |
| P0.8g-impl | P0.8g-impl write path complete: openstock_shadow.rs + shadow_kline.rs + 3 CLI subcommands + 8 default-CI tests + 2 #[ignore] integration tests. fmt/clippy/test/OpenSpec/scope-check all green. | `bb5067fbd92e2e8c9291b6ff391cdfd4256b7981` | P0.8g-impl write path complete: openstock_shadow.rs + shadow_kline.rs + 3 CLI subcommands + 8 default-CI tests + 2 #[ignore] integration tests. fmt/clippy/test/OpenSpec/scope-check all green. |
