...
This project is indexed by GitNexus as **quantix-rust** (16595 symbols, 31462 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
