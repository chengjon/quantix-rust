...
This project is indexed by GitNexus as **quantix-rust** (4569 symbols, 11482 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
