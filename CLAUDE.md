...
This project is indexed by GitNexus as **quantix-rust** (19231 symbols, 35131 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
