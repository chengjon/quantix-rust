...
This project is indexed by GitNexus as **quantix-rust** (18785 symbols, 34472 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
