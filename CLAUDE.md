...
This project is indexed by GitNexus as **quantix-rust** (16332 symbols, 31941 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
