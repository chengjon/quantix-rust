...
This project is indexed by GitNexus as **quantix-rust** (16392 symbols, 31897 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
