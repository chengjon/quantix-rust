...
pub(super) async fn run_screener_command(cmd: ScreenerCommands) -> Result<()> {
...
pub(super) struct ScreenerPresetSpec {
    pub name: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(super) enum ScreenerCommandOutput {
...
pub(super) async fn execute_screener_command_with_loader<L>(
