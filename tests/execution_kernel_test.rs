...
use quantix_cli::execution::models::{
    translate_signal, ExecutionPolicy, OrderSide, OrderStatus, OrderType, SignalEnvelope,
};
...
impl ExecutionAdapter for CountingAdapter {
    async fn submit_order(
        ...
        *self.submissions.lock().unwrap() += 1;
        Ok(quantix_cli::execution::adapter::OrderInitialResponse {
            ...
            latest_status: quantix_cli::execution::models::OrderStatus::Filled,
    ...
    async fn query_order(
        ...
        Ok(quantix_cli::execution::adapter::OrderQueryResponse {
            ...
            latest_status: quantix_cli::execution::models::OrderStatus::Unknown,
            filled_quantity: 0,
            avg_fill_price: None,
        })
    }
...
impl RiskEvaluator for FixedRiskEvaluator {
    async fn evaluate(&self, _intent: quantix_cli::execution::models::OrderIntent) -> Result<RiskDecision> {
