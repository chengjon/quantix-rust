...
- formal sequence: /opt/claude/quantix-rust/logs/market_cli_formal_sequence_20260424_015500.log
...
- formal:
  - sync industry exit=0 log=/opt/claude/quantix-rust/logs/market_cli_sync_industry_20260424_015500.log
    - summary: exit=0 completed; see log for refreshed industry reference details
  - market foundation exit=0 log=/opt/claude/quantix-rust/logs/market_cli_market_foundation_20260424_015500.log
  ...
  - market strength exit=0 log=/opt/claude/quantix-rust/logs/market_cli_market_strength_20260424_015500.log
    - summary: 基础数据=A股=100 行业覆盖=85 未覆盖=15; 候选股数=0; 强势首行=弱势板块:; 弱势首行=强势板块个股 Top10 总市值:; 总市值首行=强势板块个股 Top10 最新净利润:; 净利润首行=N/A
    - base: A股=100 行业覆盖=85 未覆盖=15
    - candidate_stock_count: 0
    - top_strong_sector: 弱势板块:
    - top_weak_sector: 强势板块个股 Top10 总市值:
    - top_market_cap_stock: 强势板块个股 Top10 最新净利润:
