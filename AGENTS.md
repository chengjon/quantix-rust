...
This project is indexed by GitNexus as **quantix-rust** (18172 symbols, 33844 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
