...
This project is indexed by GitNexus as **quantix-rust** (16435 symbols, 31953 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
