...
This project is indexed by GitNexus as **quantix-rust** (16371 symbols, 31859 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
