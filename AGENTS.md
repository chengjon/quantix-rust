...
This project is indexed by GitNexus as **quantix-rust** (19531 symbols, 35480 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
