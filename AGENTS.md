...
This project is indexed by GitNexus as **quantix-rust** (17710 symbols, 33120 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
