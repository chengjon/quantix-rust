...
This project is indexed by GitNexus as **quantix-rust** (16414 symbols, 31919 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
